Name:           memcached
Version:        1.4.15
Release:        2sflowtagged1
Summary:        High Performance, Distributed Memory Object Cache with Sflow

Group:          System Environment/Daemons
License:        BSD
URL:            https://github.com/jdi-tagged/memcached
Source0:        %{name}-%{version}.tar.gz
BuildRoot:      %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)

BuildRequires:  TAGlibevent-devel
BuildRequires:  perl(Test::More)
BuildRequires:  /usr/bin/prove
BuildRequires:  TAGgcc
BuildRequires:  TAGlibevent-devel > 2.0
Requires: TAGlibevent > 2.0
